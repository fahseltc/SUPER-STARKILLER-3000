var menu_state = {
  create: function() {
    ...
    var now_with_text = Utils.create_stroke_text('Now with PLOT!', 1200, 500, 20, '#FFD700');
    var now_with_text2 = Utils.create_stroke_text('and a hard boss\nat the start?!', 1200, 550, 10, '#FFD700');
