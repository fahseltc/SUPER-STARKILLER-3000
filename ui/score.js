...
class Score {
  constructor() {
    ...
    this.score_label = game.add.text(
      SCORE_BASE_POSITION_X,
      SCORE_BASE_POSITION_Y,
    ...
    this.score_label_tween = game.add
      .tween(this.score_label.scale)
      .to(
        { x: 1.05, y: 1.05 },
        SCORE_BUFFER_EMPTY_DELAY,
        Phaser.Easing.Linear.In
      )
      .to({ x: 1, y: 1 }, SCORE_BUFFER_EMPTY_DELAY, Phaser.Easing.Linear.In);
